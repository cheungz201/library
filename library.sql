...
(88888,'0aa021fbb199b2c1275103bee6e3b358','admin');
...
(3,'何以笙箫默','顾漫 sdf 的身份','朝华出版社','9787505414709','一段年少时的爱恋，牵出一生的纠缠。大学时代的赵默笙阳光灿烂，对法学系大才子何以琛一见倾心，开朗直率的她拔足倒追，终于使才气出众的他为她停留驻足。然而，不善表达的他终于使她在一次伤心之下远走他乡……','中文','15.00','2019-11-07',7,0),
...
(6,'明朝那些事儿（1-9）','当年明月 ','中国海关出版社','9787801656087','《明朝那些事儿》讲述从1344年到1644年，明朝三百年间的历史。作品以史料为基础，以年代和具体人物为主线，运用小说的笔法，对明朝十七帝和其他王公权贵和小人物的命运进行全景展示，尤其对官场政治、战争、帝王心术着墨最多。作品也是一部明朝政治经济制度、人伦道德的演义。','中文','358.20','2009-04-06',11,2),

(7,'经济学原理（上下）','[美] 曼昆 ','机械工业出版社','9787111126768','此《经济学原理》的第3版把较多篇幅用于应用与政策，较少篇幅用于正规的经济理论。书中主要从供给与需求、企业行为与消费者选择理论、长期经济增长与短期经济波动以及宏观经济政策等角度深入浅出地剖析了经济学家们的世界观。','英文','88.00','2003-08-05',6,0),
...
(18,'测试','测试','xx出版','8889','测试','java','6666.00','2020-05-15',54564,998);
...
(1,1,10000,'2020-03-18','2020-03-18'),

(2,2,10001,'2020-03-18','2020-03-18'),

(3,3,10003,'2020-03-18','2020-03-18'),

(4,4,10000,'2020-03-18','2020-03-18'),

(5,5,10002,'2020-03-18','2020-03-18'),

(6,6,10000,'2020-03-18','2020-03-18'),

(7,1,10001,'2020-03-18','2020-03-18'),

(8,3,10000,'2020-03-18','2020-03-18'),

(9,6,10000,'2020-03-17','2020-05-14'),

(10,5,10001,'2020-05-03','2020-05-03'),

(11,18,10001,'2020-05-03',NULL),

(12,10,10000,'2020-05-14',NULL),

(13,7,10000,'2020-05-14',NULL);
...
(10000,'黄二红','女','1999-09-09','北京','12345678900'),
